...
至于hexo+github pages的组合博客，你有福了，作者就是在hexo上开发的，具体参见作者的这个github repo:
[hexo-helper-live2d](https://github.com/EYHN/hexo-helper-live2d)，按照说明安装即可。  
那么像我这样jekyll+github pages组合的朋友们可如何是好？  
...
怎么样，是不是喜出望外，激动地想要[打赏](https://www.oukohou.wang/donate/)我却不知如何打赏?  
